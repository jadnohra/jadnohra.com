...
CtVector3::CtVector3(const FastUnitCoordSys& coordSys, const float& nx, const float& ny, const float& nz) {

	coordSys.setRUF(nx, ny, nz, el);
}

Vector3::Vector3(const FastUnitCoordSys& coordSys, const float& nx, const float& ny, const float& nz) {
