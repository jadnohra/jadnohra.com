...
void    AAB3::add(const Sphere &s) {

	AAB3 sBox;

	sBox.min.x = s.center.x - s.radius;
	sBox.max.x = s.center.x + s.radius;

	sBox.min.y = s.center.y - s.radius;
	sBox.max.y = s.center.y + s.radius;

	sBox.min.z = s.center.z - s.radius;
	sBox.max.z = s.center.z + s.radius;
