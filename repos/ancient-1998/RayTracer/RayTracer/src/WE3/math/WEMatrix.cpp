...
void Matrix4x4::scale(const float& factor) {
	...
	row_1.mul(factor); el_14 *= factor;
	row_2.mul(factor); el_24 *= factor;
	row_3.mul(factor); el_34 *= factor;
	row_4.mul(factor); el_44 *= factor;
}

float determinant(const Matrix4x4 &m) {

	return
		 m._m03 * m._m12 * m._m21 * m._m30-m._m02 * m._m13 * m._m21 * m._m30-m._m03 * m._m11 * m._m22 * m._m30+m._m01 * m._m13    * m._m22 * m._m30+
...
void inverse(const Matrix4x4 &m, Matrix4x4 &r) {
   ...
   r._m00 = m._m12*m._m23*m._m31 - m._m13*m._m22*m._m31 + m._m13*m._m21*m._m32 - m._m11*m._m23*m._m32 - m._m12*m._m21*m._m33 + m._m11*m._m22*m._m33;
   r._m01 = m._m03*m._m22*m._m31 - m._m02*m._m23*m._m31 - m._m03*m._m21*m._m32 + m._m01*m._m23*m._m32 + m._m02*m._m21*m._m33 - m._m01*m._m22*m._m33;
   r._m02 = m._m02*m._m13*m._m31 - m._m03*m._m12*m._m31 + m._m03*m._m11*m._m32 - m._m01*m._m13*m._m32 - m._m02*m._m11*m._m33 + m._m01*m._m12*m._m33;
   r._m03 = m._m03*m._m12*m._m21 - m._m02*m._m13*m._m21 - m._m03*m._m11*m._m22 + m._m01*m._m13*m._m22 + m._m02*m._m11*m._m23 - m._m01*m._m12*m._m23;
   r._m10 = m._m13*m._m22*m._m30 - m._m12*m._m23*m._m30 - m._m13*m._m20*m._m32 + m._m10*m._m23*m._m32 + m._m12*m._m20*m._m33 - m._m10*m._m22*m._m33;
   r._m11 = m._m02*m._m23*m._m30 - m._m03*m._m22*m._m30 + m._m03*m._m20*m._m32 - m._m00*m._m23*m._m32 - m._m02*m._m20*m._m33 + m._m00*m._m22*m._m33;
   r._m12 = m._m03*m._m12*m._m30 - m._m02*m._m13*m._m30 - m._m03*m._m10*m._m32 + m._m00*m._m13*m._m32 + m._m02*m._m10*m._m33 - m._m00*m._m12*m._m33;
   r._m13 = m._m02*m._m13*m._m20 - m._m03*m._m12*m._m20 + m._m03*m._m10*m._m22 - m._m00*m._m13*m._m22 - m._m02*m._m10*m._m23 + m._m00*m._m12*m._m23;
   r._m20 = m._m11*m._m23*m._m30 - m._m13*m._m21*m._m30 + m._m13*m._m20*m._m31 - m._m10*m._m23*m._m31 - m._m11*m._m20*m._m33 + m._m10*m._m21*m._m33;
   r._m21 = m._m03*m._m21*m._m30 - m._m01*m._m23*m._m30 - m._m03*m._m20*m._m31 + m._m00*m._m23*m._m31 + m._m01*m._m20*m._m33 - m._m00*m._m21*m._m33;
   r._m22 = m._m01*m._m13*m._m30 - m._m03*m._m11*m._m30 + m._m03*m._m10*m._m31 - m._m00*m._m13*m._m31 - m._m01*m._m10*m._m33 + m._m00*m._m11*m._m33;
   r._m23 = m._m03*m._m11*m._m20 - m._m01*m._m13*m._m20 - m._m03*m._m10*m._m21 + m._m00*m._m13*m._m21 + m._m01*m._m10*m._m23 - m._m00*m._m11*m._m23;
   r._m30 = m._m12*m._m21*m._m30 - m._m11*m._m22*m._m30 - m._m12*m._m20*m._m31 + m._m10*m._m22*m._m31 + m._m11*m._m20*m._m32 - m._m10*m._m21*m._m32;
   r._m31 = m._m01*m._m22*m._m30 - m._m02*m._m21*m._m30 + m._m02*m._m20*m._m31 - m._m00*m._m22*m._m31 - m._m01*m._m20*m._m32 + m._m00*m._m21*m._m32;
   r._m32 = m._m02*m._m11*m._m30 - m._m01*m._m12*m._m30 - m._m02*m._m10*m._m31 + m._m00*m._m12*m._m31 + m._m01*m._m10*m._m32 - m._m00*m._m11*m._m32;
   r._m33 = m._m01*m._m12*m._m20 - m._m02*m._m11*m._m20 + m._m02*m._m10*m._m21 - m._m00*m._m12*m._m21 - m._m01*m._m10*m._m22 + m._m00*m._m11*m._m22;
