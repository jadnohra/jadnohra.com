...
- **2021-2022 - VTT Simulation Platform** at <span class="career">[#3 Argo AI](#career)</span>
  - Engineering Manager for Virtual Test Tooling — comprehensive simulation platform for autonomous vehicle testing. Designed multi-layer simulation architecture and led development of physics-based simulation models.
