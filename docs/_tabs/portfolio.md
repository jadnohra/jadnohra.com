...
Technical chronology showing projects, algorithms, study, and career connections.
...
- Tech: Rust, FPGA, Zero-Knowledge Proofs
- Built on: All prior systems engineering, low-level optimization from Havok
...
- Built on: Simulation expertise from Argo/Audi

---

### Jun 2021 → Argo AI - Engineering Manager & Staff Software Engineer
- Simulation lead, systems engineering, V&V
- Built on: Sensor simulation from Audi AID

---

### Apr 2018 → Audi AID - Simulation Tech Lead
- Built 4 teams (20 engineers): SIL framework, traffic sim, sensor sim
- Built on: Physics simulation from Havok
...
- Tech: Julia, GLPK
- Algorithms: [Custom LP solver](https://github.com/jadnohra/jad-pre-2015-dabblings/blob/master/Lab2015/mlcp2.0/lp_glpk.jl), [LU decomposition](https://github.com/jadnohra/jad-pre-2015-dabblings/blob/master/Lab2015/mlcp2.0/lu.jl), MLCP benchmarks
- Built on: lamby MLCP research (2013), LCP study notes
...
- → Applied: Havok solver optimization
...
- Built on: Physics and numerical work at Havok

---

### Jul 2015 - [asinus_salutem](https://github.com/jadnohra/jad-pre-2015-dabblings/tree/master/Lab2015/asinus_salutem)
- Tech: Python, SymPy
- Algorithms: [Tokenization, expression parsing, AST](https://github.com/jadnohra/jad-pre-2015-dabblings/blob/master/Lab2015/asinus_salutem/as.py)
- → Used for: Mathematical exploration tooling
...
- Core physics engine, SIMD optimization, geometric queries
...
- Built on: Navigation (RecastMOD), Animation (Bigfoot), AI Sandbox work

---

### May 2011 - [Floating Point Analysis](https://github.com/jadnohra/jad-pre-2015-dabblings/tree/master/Labs/fp)
- Tech: Python, C++
- Algorithms: IEEE 754 bit manipulation, epsilon calculation, denormalized numbers
...
- Algorithms:
  - [Voxelization](https://github.com/jadnohra/jad-pre-2015-dabblings/blob/master/Labs/AI/RecastMOD/Recast/Source/RecastRasterization.cpp)
  - [Navmesh generation](https://github.com/jadnohra/jad-pre-2015-dabblings/blob/master/Labs/AI/RecastMOD/Recast/Source/RecastMesh.cpp)
  - [A* pathfinding](https://github.com/jadnohra/jad-pre-2015-dabblings/blob/master/Labs/AI/RecastMOD/Detour/Source/DetourStatNavMesh.cpp)
  - [Tiled streaming](https://github.com/jadnohra/jad-pre-2015-dabblings/blob/master/Labs/AI/RecastMOD/Detour/Source/DetourTileNavMesh.cpp)
- Built on: AI Sandbox pathfinding work
- Study: [Collision Detection](https://github.com/jadnohra/TheNotes/blob/master/2016/notes_coll_det.pdf)
- → Applied: AI Sandbox (HPA*, terrain clustering) → Guerrilla (automated navigable space)
...
- Algorithms:
  ...
  - [Skeleton analysis](https://github.com/jadnohra/jad-pre-2015-dabblings/blob/master/Labs/Bigfoot/src/BF/SkeletonAnalyzer.cpp)
  - [Physics model](https://github.com/jadnohra/jad-pre-2015-dabblings/blob/master/Labs/Bigfoot/src/BF/SkeletonPhysicsModel.h) - rigid body dynamics, Lagrange multipliers
  - [Locomotion planner](https://github.com/jadnohra/jad-pre-2015-dabblings/blob/master/Labs/Bigfoot/src/BF/Locomo.cpp) - footstep planning, stride geometry
  - [Motion retargeting](https://github.com/jadnohra/jad-pre-2015-dabblings/blob/master/Labs/Bigfoot/src/Retarget.cpp)
- Built on: Puppeteer (BVH loading), Bigeye (UI framework)
- Study: [Rigid Body Dynamics](https://github.com/jadnohra/TheNotes/blob/master/2017/treat_rbd_1.pdf), [Lagrangian Framework](https://github.com/jadnohra/TheNotes/blob/master/2015/lagrfrmw.pdf), [Rotation Mathematics](https://github.com/jadnohra/TheNotes/blob/master/2015/rotation.pdf)
- → Applied: AI Sandbox (motion graphs) → Guerrilla (humanoid motion) → Havok animation R&D
...
- Algorithms: Armature traversal, coordinate system conversion
...
- Tech: C++, OpenGL, MagickWand, Win32
- Algorithms: Retained-mode rendering, scene graph traversal, widget events
- → Used in: Bigfoot, rapid prototyping throughout career

---

### Apr 2010 - [Puppeteer](https://github.com/jadnohra/jad-pre-2015-dabblings/tree/master/Labs/Puppeteer) (BVH Viewer)
- Tech: C++, OpenGL, GLM
- Algorithms: BVH loading, skeletal rendering
- → Used in: Bigfoot animation system

---

### 2009 → Guerrilla Games (Sony) - Senior AI Programmer
- Killzone 3: motion planning (humanoids, vehicles), multiplayer bots, Maya tooling
- Built on: AI Sandbox locomotion, RecastMOD navigation, Bigfoot animation
...
- Tech: C++
- Algorithms: HPA* (Hierarchical Path-Finding A*), locomotion system, reinforcement learning
- Co-authored: "The Secrets of Parallel Pathfinding on Modern Computer Hardware"
- Built on: Personal AI projects (TicTacToe, Obstacle Avoidance)
- Study: AI Game Programming Wisdom series (4 volumes) - later sold for $500 when out of print
- → Applied: Guerrilla Games AI, Havok pathfinding
...
- Tech: C++, Visual Studio 2008
- Algorithms: Minimax, Alpha-Beta pruning, Reinforcement Learning (Value Iteration)
- Study: [FOL notes](https://github.com/jadnohra/TheNotes/blob/master/2018/Free%20Occurrences%20in%20FOL.pdf)
- → Applied: AI Sandbox RL contribution
...
- Tech: C++, OpenGL, Win32
- Algorithms: BSP traversal, PVS culling, lightmaps, texture streaming
- Built on: thrashit3d renderer (1998)
- → Used in: Visualization for AI projects

---

### 2008 → Sixteen Tons
- Nintendo DS engine, stochastic game AI
- Built on: Kimera engine experience

---

### 2006-2008 → Kimera Studios - [World-Of-Football](https://github.com/jadnohra/World-Of-Football)
- Complete engine: rendering, physics, animation, NN goalkeeper AI
- Built on: University-era 3D graphics (thrashit3d, xu1)

---

### 1998 - University Projects (AUB)
- **GraphEdit** - 3D equation grapher with distributed computing, equation parsing, light rendering
- **thrashit3d** - 3D software renderer
- **xu1** - 3D racing game
- **watereffect** - 2D water effect
