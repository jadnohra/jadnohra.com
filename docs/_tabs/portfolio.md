...
- **May 2019 - [TheNotes](https://github.com/jadnohra/TheNotes)** — Study notes 2013-2018 published to GitHub
  ...
  - <span class="study">[LinAlg Done Right](https://github.com/jadnohra/TheNotes/blob/master/2019/memo_linear-algebra-done-right.pdf), [2022 robotics transforms](https://github.com/jadnohra/TheNotes/blob/master/2022/mapping_robotics_transform_terminology_to_abstract_linear_algebra.pdf)</span>
...
- **2017 - Study: Programming Logic**
  - Deep dive into type theory and lambda calculus foundations.
  - <span class="study">[plql](https://github.com/jadnohra/TheNotes/blob/master/2017/plql.pdf), [plql_short](https://github.com/jadnohra/TheNotes/blob/master/2016/plql_short.pdf), [plql_pl_flavors](https://github.com/jadnohra/TheNotes/blob/master/2016/plql_pl_flavors.pdf), [compute](https://github.com/jadnohra/TheNotes/blob/master/2017/compute.pdf)</span>
...
- **2017 - Study: Rigid Body Dynamics**
  - Formalized physics understanding after years at <span class="career">[#5 Havok](#career)</span>.
...
- **2016 - Study: Analysis & Geometry**
  - Rigorous study of differential geometry and real analysis.
  - <span class="study">[Differential Forms](https://github.com/jadnohra/TheNotes/blob/master/2016/dform.pdf), [road_dform](https://github.com/jadnohra/TheNotes/blob/master/2017/road_dform.pdf), [Manifolds](https://github.com/jadnohra/TheNotes/blob/master/2016/mfold_short.pdf), [Lagrange proof](https://github.com/jadnohra/TheNotes/blob/master/2016/proof_lagrmul.pdf), [Analysis](https://github.com/jadnohra/TheNotes/blob/master/2016/treat_analy_1.pdf), [MVT/IVT/Taylor](https://github.com/jadnohra/TheNotes/blob/master/2016/hand_mvt_ivt_taylor_onot.pdf), [Measure](https://github.com/jadnohra/TheNotes/blob/master/2016/meas_short.pdf), [Continuity](https://github.com/jadnohra/TheNotes/blob/master/2016/cont_short.pdf), [pointillistic](https://github.com/jadnohra/TheNotes/blob/master/2016/pointillistic.pdf)</span>
...
- **Sep 2015 - [MLCP 2.0](https://github.com/jadnohra/jad-pre-2015-dabblings/tree/master/Lab2015/mlcp2.0)** — LP solver in Julia
  - <span class="algo">Tech: Julia, GLPK. Algorithms: [LP solver](https://github.com/jadnohra/jad-pre-2015-dabblings/blob/master/Lab2015/mlcp2.0/lp_glpk.jl), [LU decomposition](https://github.com/jadnohra/jad-pre-2015-dabblings/blob/master/Lab2015/mlcp2.0/lu.jl).</span>
  - <span class="study">[Eigenvalues](https://github.com/jadnohra/TheNotes/blob/master/2013-2014%20/Notes%20on%20Parlett's%20The%20Symmetric%20Eigenvalue%20Problem.pdf), [eigenvalues2](https://github.com/jadnohra/TheNotes/blob/master/2013-2014%20/notes%20on%20eigenvalues.pdf)</span>
...
- **2013-2014 - Deep Mathematical Study** at <span class="career">[#5 Havok](#career)</span>
  ...
  - <span class="algo">[lamby](https://github.com/jadnohra/jad-pre-2015-dabblings/tree/master/Labs/Physics/lamby), [GJK impl](https://github.com/jadnohra/jad-pre-2015-dabblings/blob/master/Labs/Physics/fc/gjk/gjk0.py)</span>
...
- **May 2011 - [Floating Point Analysis](https://github.com/jadnohra/jad-pre-2015-dabblings/tree/master/Labs/fp)** — IEEE 754 deep dive
  - <span class="algo">Tech: Python, C++. Algorithms: IEEE 754 bit manipulation, epsilon calculation, denormals.</span>
  - <span class="study">[asymp_not](https://github.com/jadnohra/TheNotes/blob/master/2016/asymp_not.pdf)</span>
...
- **Nov 2010 - [RecastMOD](https://github.com/jadnohra/jad-pre-2015-dabblings/tree/master/Labs/AI/RecastMOD)** — Navigation mesh system
  - <span class="algo">Tech: C++, OpenGL, Recast & Detour. Algorithms: [Voxelization](https://github.com/jadnohra/jad-pre-2015-dabblings/blob/master/Labs/AI/RecastMOD/Recast/Source/RecastRasterization.cpp), [Navmesh](https://github.com/jadnohra/jad-pre-2015-dabblings/blob/master/Labs/AI/RecastMOD/Recast/Source/RecastMesh.cpp), [A*](https://github.com/jadnohra/jad-pre-2015-dabblings/blob/master/Labs/AI/RecastMOD/Detour/Source/DetourStatNavMesh.cpp).</span>
  - <span class="study">[Collision Detection](https://github.com/jadnohra/TheNotes/blob/master/2016/notes_coll_det.pdf), [algcrumb](https://github.com/jadnohra/TheNotes/blob/master/2016/algcrumb.pdf)</span>
...
- **Aug 2010 - [Bigfoot Animation](https://github.com/jadnohra/jad-pre-2015-dabblings/tree/master/Labs/Bigfoot)** — Skeletal animation with physics
  - <span class="algo">Tech: C++, OpenGL, GLM, Bigeye UI. Algorithms: [BVH](https://github.com/jadnohra/jad-pre-2015-dabblings/blob/master/Labs/Bigfoot/src/BF/LoaderBVH.cpp), [Skeleton](https://github.com/jadnohra/jad-pre-2015-dabblings/blob/master/Labs/Bigfoot/src/BF/SkeletonAnalyzer.cpp), [Physics](https://github.com/jadnohra/jad-pre-2015-dabblings/blob/master/Labs/Bigfoot/src/BF/SkeletonPhysicsModel.h), [Locomotion](https://github.com/jadnohra/jad-pre-2015-dabblings/blob/master/Labs/Bigfoot/src/BF/Locomo.cpp), [Retarget](https://github.com/jadnohra/jad-pre-2015-dabblings/blob/master/Labs/Bigfoot/src/Retarget.cpp).</span>
  - <span class="study">[RBD](https://github.com/jadnohra/TheNotes/blob/master/2017/treat_rbd_1.pdf), [Lagrangian](https://github.com/jadnohra/TheNotes/blob/master/2015/lagrfrmw.pdf), [Rotation](https://github.com/jadnohra/TheNotes/blob/master/2015/rotation.pdf), [Covariance](https://github.com/jadnohra/TheNotes/blob/master/2015/covar.pdf), [Hestenes GA](https://github.com/jadnohra/TheNotes/blob/master/2015/Notes%20on%20Hestenes%27%20%27Reforming%20the%20Mathematical%20Language%20of%20Physics%27.pdf)</span>
...
- **Aug 2010 - [BlenderToBVH](https://github.com/jadnohra/jad-pre-2015-dabblings/tree/master/Labs/BlenderToBVH)** — Animation export tool
  - <span class="algo">Tech: Python, Blender API. Algorithms: Armature traversal, coordinate system conversion.</span>
...
- **May 2010 - [Bigeye UI](https://github.com/jadnohra/jad-pre-2015-dabblings/tree/master/Labs/Bigeye)** — UI framework
  - <span class="algo">Tech: C++, OpenGL, MagickWand, Win32. Algorithms: Retained-mode rendering, scene graph.</span>
...
- **Apr 2010 - [Puppeteer](https://github.com/jadnohra/jad-pre-2015-dabblings/tree/master/Labs/Puppeteer)** — BVH viewer
  - <span class="algo">Tech: C++, OpenGL, GLM. Algorithms: BVH loading, skeletal rendering.</span>
...
- **2008-2010 - [AI Sandbox](https://web.archive.org/web/20190719084901/http://aigamedev.com/articles/?tx_ttnews%5Bcat%5D=17&cHash=93c15cd059)** at <span class="career">[#7 AiGameDev](#career)</span>
  - <span class="algo">Tech: C++. Algorithms: HPA*, locomotion system, reinforcement learning.</span>
  - <span class="study">AI Game Programming Wisdom (4 vols, sold $500), [ml_survey](https://github.com/jadnohra/TheNotes/blob/master/2016/ml_survey.pdf)</span>
...
- **Apr 2009 - [Obstacle Avoidance](https://github.com/jadnohra/jad-pre-2015-dabblings/tree/master/Labs/AI)** — Steering behaviors
  - <span class="algo">Tech: C++, 2D visualization. Algorithms: Velocity obstacles, collision prediction, steering.</span>
...
- **Apr 2009 - [TicTacToe AI](https://github.com/jadnohra/jad-pre-2015-dabblings/tree/master/Labs/AI/TicTacToe)** — AI algorithms testbed
  - <span class="algo">Tech: C++, Visual Studio. Algorithms: Minimax, Alpha-Beta, RL (Value Iteration).</span>
  - <span class="study">[FOL](https://github.com/jadnohra/TheNotes/blob/master/2018/Free%20Occurrences%20in%20FOL.pdf), [plql](https://github.com/jadnohra/TheNotes/blob/master/2017/plql.pdf)</span>
...
- **Apr 2009 - [Graphics Framework](https://github.com/jadnohra/jad-pre-2015-dabblings/tree/master/Labs/Graphics/Framework1)** — Quake3 BSP renderer
  - <span class="algo">Tech: C++, OpenGL, Win32. Algorithms: BSP traversal, PVS culling, lightmaps.</span>
...
- **2006-2008 - [World-Of-Football](https://github.com/jadnohra/World-Of-Football)** at <span class="career">[#9 Kimera](#career)</span>
  - <span class="algo">Tech: C++, DirectX. Complete engine: rendering, physics, animation, NN goalkeeper AI.</span>
  - Foundation for <span class="career">[#8 Sixteen Tons](#career)</span> and <span class="career">[#7 AiGameDev](#career)</span>.

- **1998 - University Projects (AUB)**
  - GraphEdit (3D equation grapher with distributed computing), thrashit3d (software renderer), xu1 (3D racing), watereffect, 2dshooter, RayTracer.
  - <span class="algo">Tech: C++, Win32, software rendering.</span>
