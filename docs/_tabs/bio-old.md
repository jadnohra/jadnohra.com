...
- **Mini Projects**
  - **Feb 2026 - [vram.run](https://vram.run)** — Search a model: see which API providers serve it, which GPUs can run it locally (and how fast), and what cloud rental would cost. Or search your hardware and see what fits. 19 providers, 220+ hardware configs, 30+ cloud GPUs. Also a Rust [CLI](https://github.com/jadnohra/hf-providers). <span class="algo">Rust, TypeScript, HF Inference API.</span>
  ...
  <div class="thumb-strip"><img src="/assets/img/portfolio/vram-run-screenshot.png"><img src="/assets/img/portfolio/psychotron-screenshot.png"><img src="/assets/img/portfolio/recent-work-screenshot.png"><img src="/assets/img/portfolio/thatslop-float-panel.png"><img src="/assets/img/portfolio/eliza2-screenshot.png"></div>
...
- **2024-2025 - Linerate ZK Hardware Acceleration**
  ...
  <div class="thumb-strip"><img src="/assets/img/portfolio/fpga-cli.png"></div>
...
- **~2016 - HKDS High-Fidelity Solver** at <span class="career">[#5 Havok](#career)</span>
  ...
  - **Context:** [HKDS overview](https://github.com/jadnohra/projects-pre-2015/blob/master/hkds/ds_overview1.pdf). [More detail](https://github.com/jadnohra/projects-pre-2015/blob/master/hkds/ds_detail.pdf). Videos: [Titan arm](https://github.com/jadnohra/projects-pre-2015/blob/master/hkds/HifiSolverVid/arm.mp4), [Digger](https://github.com/jadnohra/projects-pre-2015/blob/master/hkds/HifiSolverVid/digger.mp4). YouTube: [Titan4 Robot Arm](https://lnkd.in/d37wkfwN), [Digger](https://lnkd.in/dtk9hiji), [Digger & Terrain](https://lnkd.in/dHMhEKya). Prerequisites: [Rotations and Basics](https://github.com/jadnohra/projects-pre-2015/blob/master/hvk_other/TheMathematicsOfHavoksSolver.pdf), work on stabilizing constraints, notebook notes on 'universal constraint', [substepping algorithm](https://github.com/jadnohra/projects-pre-2015/blob/master/hvk_other/substep1.pdf) (a stumbling block for others at multiple occasions). Prototyping using Julia: [MLCP solver](https://github.com/jadnohra/projects-pre-2015/blob/master/Labs/Lab2015/mlcp2.0/lp_jad.jl). Dynamics debugging tool: [trace](https://github.com/jadnohra/trace).
...
- **~2015-2017 - HoloLens Spatial Localization R&D** at <span class="career">Microsoft (within [#5](#career))</span>
  - Research and prototyping for HoloLens mixed reality localization — spatial anchor systems, loop closure algorithms, and physics-based spatial mapping for AR applications.
  <div class="thumb-strip"><img src="/assets/img/portfolio/ms-sfr-visual-place.jpg"><img src="/assets/img/portfolio/ms-bendphys.jpg"><img src="/assets/img/portfolio/ms-phys-play.jpg"><img src="/assets/img/portfolio/ms-pruning-occup.jpg"></div>
  - **Spatial Frame of Reference (SFR):** Walk graph construction with anchor nodes, coordinate system baking, hologram placement relative to spatial anchors. IMU integration for tracking.
  - **Physics-Based Localization:** Loop closure detection, spatial mesh deformation, jitter compensation for stable hologram anchoring.
  - **Spatial Mapping:** Occupancy grid segmentation, point cloud processing, physics object overlay on real environments.
  - <span class="algo">Tech: C++. Algos: [Graph optimization](https://en.wikipedia.org/wiki/Graph_optimization), [Loop closure](https://en.wikipedia.org/wiki/Simultaneous_localization_and_mapping#Loop_closure), [Spatial anchors](https://en.wikipedia.org/wiki/Spatial_computing), [Occupancy grids](https://en.wikipedia.org/wiki/Occupancy_grid_mapping).</span>
  - **Patent:** [US10672159B2 - Anchor graph spatial optimization](https://patents.google.com/patent/US10672159B2/en).
